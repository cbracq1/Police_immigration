...
indiv_doi = indiv %>% dplyr::select(-c("origine_tous_g2_rec","origine_tous_g2_code","group1","group1_rec","taux_confiance","a_confiance","i_cnfpol_rec","i_cnfpol","uc_reve_isna","l_immi_code","a_rquart_code","i_cnfjus","i_ecole","i_contri","l_immi","a_rquart","qpv_i","l_quart_secu","sexee","f_dip","csnq_premp","csnq_ego"))
