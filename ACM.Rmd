...
```{r}
res1 <- MCA(indiv_acm1, quali.sup = 4:13, quanti.sup = 14:16, ind.sup= indices[1:16000], row.w = indiv_acm1_poids$poidsi)#les supplémentaires sont aux rang 8à 16#quanti.sup = c(8, 11),
