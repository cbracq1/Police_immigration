...
indiv_acm2 <- indiv %>%
  ...
  select(i_cnfpol_rec, i_contri_rec, d_lieudisagr_d_rec, origine_tous_g2_rec, l_immi_rec, a_rquart_code, l_quart_secu_rec, qpv_i_rec, sexee_rec, csnq_ego_rec, durtotfrm, durar2, agenq, ident, poidsi)  
...
```{r}
res <- MCA(indiv_acm2, quali.sup = 4:10, quanti.sup = 11:13, row.w = indiv_acm2_poids$poidsi)
