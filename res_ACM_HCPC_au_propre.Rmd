...
ggtable(
  acm2_classe, 
  columnsX = "clust", 
  columnsY = c("i_cnfpol_rec", "i_contri_rec", "d_lieudisagr_d_rec", "compor_discri","origine_tous_g2_rec", "qpv_i_rec", "l_quart_secu_rec", "csnq_ego_rec", "l_immi_rec", "sexee_rec", "durar2", "agenq"),
