...
ok: 
i_cnfpol, i_cnfjus, i_ecole, i_contri, génération et origine (origine_tous_g2), sexe (sexee), group1, sécurité du quartier(l_quart_secu),QPV (qpv_i), présence d'immigrés dans le quartier (l_immi)

à faire :
relations dans le quartier, indicateurs niveau socioéco
